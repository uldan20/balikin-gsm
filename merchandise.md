...
> **Merchandise Balikin adalah barang-barang yang paling sering hilang —
> dan tiap satuannya sudah terdaftar di Balikin.**

Aplikasi ini punya 13 Kategori Barang: tas, dompet, kunci, HP, dokumen,
kartu identitas, kacamata, payung, tumbler, hewan, perhiasan, elektronik,
lainnya. Daftar itu, kalau dibaca ulang, adalah **daftar belanja merchandise
yang sudah jadi**. Tumbler, payung, gantungan kunci, *cardholder*, lap
kacamata, tas — semuanya barang yang memang dijual sebagai merchandise, dan
semuanya kebetulan barang yang paling sering ditinggal orang.

Tiga hal yang didapat dari mengunci konsep ini:

1. **Merchandise-nya memperagakan produknya.** Tiap item digantungi Tag
   Balikin ber-QR. Pengunjung pulang membawa barang yang benar-benar
   terhubung ke sistem, bukan suvenir berlogo.
2. **Ada alasan kenapa item ini yang dipilih**, bukan "karena tote bag murah".
   Penguji hampir pasti menanyakan ini.
3. **Booth punya alur cerita.** Meja pameran berubah jadi meja barang temuan.

Satu kalimat untuk dipajang di booth dan diucapkan waktu sidang:
...
Kalau anggaran atau waktu menipis, potong dari bawah. **Tingkat A saja sudah
cukup untuk booth yang utuh.**
...
| --- | --- | --- | --- | --- | --- |
| A1 | **Tag Balikin (QR)** — heksagon akrilik 4 cm + tali | Item pahlawan. Ini produknya, bukan suvenirnya | 150 | 8–15rb | 1,2–2,3jt |
| A2 | **Kartu Balikin** — ukuran ATM, PVC, QR + "Kalau dompet ini ketemu, pindai" | Masuk dompet, dibawa terus, biaya paling rendah per orang | 200 | 3–6rb | 600rb–1,2jt |
...
Menaikkan kelas booth dari "rapi" ke "digarap serius".

| # | Item | Catatan | Jumlah | Est. satuan |
| --- | --- | --- | --- | --- |
| B1 | **Tote bag** blacu/kanvas, sablon 1–2 warna | Kategori "Tas". Pakai juga sebagai wadah paket giveaway | 20–30 | 25–40rb |
| B2 | **Payung lipat** | Kategori "Payung" — barang tertinggal nomor satu di kafe. Sangat fotogenik di booth | 3–5 | 45–80rb |
| B3 | **Lap kacamata** microfiber | Kategori "Kacamata". Murah, ringan, terasa premium | 50 | 6–12rb |
| B4 | **Pin enamel** — 9 Lencana Pencapaian | Koleksi tingkat lanjut; hadiah untuk yang menyelesaikan demo | 100 | 15–25rb |
| B5 | **Notes/jurnal** A6 sampul heksagon | Bidang bagus untuk memamerkan pola | 20 | 20–35rb |
| B6 | **Kaus** tim + 2 untuk dipajang | Dipakai penjaga booth, langsung jadi seragam | 5–8 | 60–90rb |
| B7 | **Mug** | Foto meja jadi hidup | 6 | 25–35rb |
| B8 | **Hangtag** tiap item | Yang membuat merchandise terbaca sebagai satu lini | 200 | 1–2rb |

**Perkiraan Tingkat B: Rp 4 – 7 juta**

### Tingkat C — Kalau anggaran masih ada

| # | Item | Catatan |
| --- | --- | --- |
| C1 | **Plushie maskot** 25–30 cm | Penarik perhatian paling kuat (lihat boneka orangutan di booth referensi). **Lead time 3–5 minggu + persetujuan sampel** — pesan paling awal atau lupakan |
| C2 | **Standee akrilik** maskot 12 cm | Versi kecil dan murah dari efek plushie |
| C3 | **Mousepad / desk mat** | Bidang lebar untuk pola heksagon |
| C4 | **Topi** | Pelengkap seragam penjaga booth |
| C5 | **Pembatas buku** heksagon | Giveaway termurah kedua setelah stiker |
| C6 | **Komik mini** 8 halaman — "Perjalanan Pulang Sebuah Kunci" | Menjelaskan alur app tanpa perlu dijelaskan orang |
| C7 | **Gantungan tas karabiner** ber-QR | Versi tahan banting dari A1, untuk tas ransel |

---

## Spesifikasi item pahlawan

### A1 · Tag Balikin (QR)

Ini yang membedakan booth ini dari booth merchandise biasa. Rancang dengan
serius.
...
- **Muka belakang** QR + kalimat:
  ...
  > *Tanpa nomor HP, tanpa alamat.*
- **Tali** paracord teal atau rantai bola stainless.

**Catatan teknis yang wajib diurus sebelum cetak:**

1. **QR harus mengarah ke halaman yang hidup selama pameran.** Kalau app-nya
   belum ter-*deploy*, cukup satu halaman web statis berisi alur "Saya
   menemukan barang ini" + tautan ke prototipe. Tag yang QR-nya mati
   menghancurkan seluruh argumen konsepnya.
...
- PVC 0,76 mm (tebal kartu ATM), ukuran 85,6 × 54 mm, sudut dipangkas 60°
  di dua sudut diagonal — mengulang tanda tangan Hexcut.
- Depan: logo + "Kartu Penemuan". Belakang: QR + tiga langkah alur penemuan.
- Paling murah per orang dan paling lama umurnya — orang menyimpannya di
  dompet berbulan-bulan.

### A4 · Gantungan kunci Tingkat Komunitas
...
menjelaskan sistem gamifikasi app-nya. Simpan Legenda Balikin hanya untuk yang
menyelesaikan demo penuh.

File SVG-nya sudah siap pakai: `assets/svg/TierNew.svg` … `TierLegend.svg`
(teal) dan `assets/svg-tintable/` (bisa diwarnai ulang) di repo `balikin`.

---

## Paket giveaway

Susun tiga tingkat hadiah supaya penjaga booth tidak bingung siapa dapat apa:
...
Sebutkan daftar ini waktu sidang — menunjukkan pilihan yang dipikirkan, bukan
kekurangan anggaran:

- **Case HP** — kategori "HP & Elektronik" memang ada, tapi tiap merek beda
  ukuran; sisa stok pasti banyak.
- **Merchandise berlogo bank / e-wallet** — README pustaka ikon sudah
  memutuskan tidak menggambar ulang merek dagang pihak ketiga. Aturan itu
  berlaku juga di merchandise.
